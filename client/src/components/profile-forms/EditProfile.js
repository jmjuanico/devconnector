...
const EditProfile = (
  {
    profile: { profile, loading }, createProfile: createProfileAction,
    getCurrentProfile: getCurrentProfileAction, history,
  },
) => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      skills: _.get(profile, 'skills', []).join(','),
  ...
  }, [profile, loading, getCurrentProfileAction]);
